...
import type { knoledgeType } from '@/typs/consult'
import FollwDoctor from '@/components/FollwDoctor.vue'
import { useConsultStore } from '@/stores/consult'
import { ConsutType } from '@/enums/index'
const active = ref<knoledgeType>('like')
      ...
      <van-row>
        ...
        <van-col span="8">
          <router-link
            to="/consult/fast"
            class="nav"
            @click="store.setType(ConsutType.fast)"
          >
